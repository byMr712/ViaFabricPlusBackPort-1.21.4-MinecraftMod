...
> support up to **26.3**. Upstream: [ViaVersion/ViaFabricPlus](https://github.com/ViaVersion/ViaFabricPlus).
...
from the first multiplayer version up to **26.3**. Original upstream functionality regarding legacy combat,
